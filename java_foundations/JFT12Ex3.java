...
public static void main(String[] args) {
        ...
        String s2 ="digity"; //Onject 2 memoray locayion 2
        ...
        System.out.println(s1.equals(s2)); // false as s1 now is now "dingity rubber"
        System.out.println(s2==s3); // true both point to the same location in memoray
